...
<body>
        ...
        <form action="../controllers/regchek_for_seller.php" onsubmit="return regva()"method="POST" enctype="multipart/form-data" align="center">
            ...
            <input type="submit" name="submitNewAccountSeller"><br><br>
